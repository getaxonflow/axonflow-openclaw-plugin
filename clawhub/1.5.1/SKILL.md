...
>
> **On an older OpenClaw CLI? The old workaround is still needed.** Versions before 2026.4.14 had a bug ([openclaw/openclaw#66618](https://github.com/openclaw/openclaw/issues/66618)) that made scoped packages fail with `ENOENT .../@axonflow/openclaw.zip` — both forms of the install command hit it. Fixed upstream in 2026.4.14. If you cannot upgrade, install from npm directly:
>
> ```bash
